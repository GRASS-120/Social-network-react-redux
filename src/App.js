...
class App extends React.Component {
  ...
  catchAllUnhendlerErrors = (reason) => {
  ...
  componentDidMount() {
    ...
    window.addEventListener("unhandledrejection", this.catchAllUnhendlerErrors)
  };

  // убираем мусор - отписка от event'a
  componentWillUnmount() {
    window.removeEventListener("unhandledrejection", this.catchAllUnhendlerErrors)
  }
